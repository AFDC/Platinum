...
authorization do
	...
	role :user do
		...
		has_permission_on :leagues, :to => [:manage_roster, :players, :reg_list, :team_list, :cancel_registration, :update_invites, :edit, :update, :setup_schedule_import, :upload_schedule, :import_schedule, :remove_future_games, :rainout_games, :process_rainout, :upload_roster, :setup_roster_import, :import_roster] do
